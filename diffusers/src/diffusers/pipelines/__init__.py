...
try:
    ...
    _import_structure["pixart_alpha"] = ["PixArtAlphaPipeline", "PixArtSigmaPipeline", "PixArtAlphaImg2ImgPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .pixart_alpha import PixArtAlphaPipeline, PixArtSigmaPipeline, PixArtAlphaImg2ImgPipeline
